...
quiero conectar CRM, Inventario Oracle, OSS/OCS, Facturación y Portal de Clientes mediante una Plataforma de Integración Empresarial,
para reducir integraciones punto a punto y asegurar consistencia operativa entre los sistemas críticos.

## Requerimientos funcionales
- La plataforma debe cumplir la funcionalidad de integrar sistemas críticos mediante la Plataforma de Integración Empresarial.
...
Scenario: Consumidor no autorizado
  ...
  When intenta ejecutar la funcionalidad de integrar sistemas críticos
  Then la plataforma debe rechazar la solicitud
