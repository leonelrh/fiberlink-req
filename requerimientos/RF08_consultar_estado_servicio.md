...
## Historia de usuario
Como asesor de atención al cliente,
quiero consultar el estado comercial, técnico y de facturación del servicio,
para brindar una respuesta consistente al cliente.

## Requerimientos funcionales
- La plataforma debe cumplir la funcionalidad de consultar estado de servicio mediante la Plataforma de Integración Empresarial.
...
Scenario: Consumidor no autorizado
  ...
  When intenta ejecutar la funcionalidad de consultar estado de servicio
  Then la plataforma debe rechazar la solicitud
