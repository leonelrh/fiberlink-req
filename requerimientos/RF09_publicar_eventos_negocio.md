# RF06 - Publicar eventos de negocio

## Historia de usuario
Como arquitecto de integración,
quiero publicar eventos de negocio desde la Plataforma de Integración,
para desacoplar los sistemas y habilitar observabilidad y analítica.

## Requerimientos funcionales
- La plataforma debe cumplir la funcionalidad de publicar eventos de negocio mediante la Plataforma de Integración Empresarial.
...
Scenario: Consumidor no autorizado
  ...
  When intenta ejecutar la funcionalidad de publicar eventos de negocio
  Then la plataforma debe rechazar la solicitud
